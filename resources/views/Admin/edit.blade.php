              ...
              <form action="/barang/{{$barang->id}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="barang" placeholder="Nama barang" name="nama_barang" value="{{$barang->nama_barang}}">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="keterangan" placeholder="Keterangan" name="keterangan" value="{{$barang->keterangan}}">
                  </div>
                  <div class="form-group">
                    <label for="gambar">Foto barang</label>
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="gambar" name="gambar" value="{{$barang->gambar}}">
