          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <div class="col-2">
                  <a href="{{ url ('/create')}}">
                    <div class="btn btn-block btn-success">+ Add</div>
                  </a>
                </div>
              </div>
              <!-- /.card-header -->
                  ...
                  <tbody>
                    ...
                    @foreach ($barangs as $barang)
                      <tr>
                        ...
                        <td>
                          <img src="{{ url ('img')}}/{{$barang->gambar}}" width="100" alt="foto barang"></td>
                        <td>Rp. {{ number_format($barang->harga)}}</td>
                        <td>{{$barang->stok}}</td>
                        <td>{{$barang->keterangan}}</td>
                        <td><a href="{{ url ('/edit')}}/{{$barang->id}}" class="btn btn-success">Edit</a> | 
